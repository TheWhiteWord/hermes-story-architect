...
Born inside The I. Never known another world. Raised in the standard curriculum with standard expectations. The only unusual thing about Kael is the persistent, nagging sense that something is off — a wrongness that has no name.
...
From passive observer to active questioner. Kael begins by trying to fix what's wrong inside the system, and ends by stepping outside it entirely — losing every certainty they ever had.
